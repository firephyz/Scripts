...
# %define dir %{_topdir}
# %define files $(ls %{dir})
# %define test $(echo FILES %files | tr ' ' '\\n' | grep BUILD)
# echo TEST %test
# exit 1
...
mkdir -p %{builddir}
# Move armv7-a multilib profile into source tree
...
%files
  ...
  # # Force user to specify fpu kind, these default ones aren't necessary
  ...
  # %exclude %{install_prefix}/libexec/gcc/arm-none-eabi/%{version}
  #
  # %{install_prefix}/libexec/gcc/arm-none-eabi/%{version}/cc1
  # %{install_prefix}/libexec/gcc/arm-none-eabi/%{version}/collect2
  # %{install_prefix}/libexec/gcc/arm-none-eabi/%{version}/lto1
  # %{install_prefix}/libexec/gcc/arm-none-eabi/%{version}/lto-wrapper
